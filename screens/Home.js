...
import {List , ListItem , Left, Button, Icon, Body, Right, CheckBox, Title, H1, Fab ,Subtitle , Container , Text,Spinner} from 'native-base'
    ...
    return (
       <ScrollView contentContainerStyle={styles.container}>
         {listOfSeasons.length == 0 ? (
           ...
           <Fab
           style={{backgroundColor:"#5067ff"}} position="bottomRight" onPress={() => navigation.navigate('Add')}><Icon name="add"/></Fab>
       </ScrollView>
    )
}
